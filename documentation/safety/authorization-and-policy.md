...
Every operation requires verified human or delegated identity, the `synthetic-data:jobs` scope, and an authorization decision for the exact resource and action. Service tokens without the required caller context are not a substitute.
